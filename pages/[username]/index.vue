  ...
  <div class="min-h-screen">
    ...
    >
      ...
      <div
        ...
        :class="{
          'border-b-1 border-b-on-surface border-b-solid':
            !profile?.coverImageId,
          'backdrop-blur-xl': profile?.coverImageId,
        }"
      >
        <div
        ...
        <PictureFrame
          ...
          :src="
            profile?.profileImageId
              ...
              : `https://api.dicebear.com/8.x/micah/svg?seed=${profile?.username}&backgroundType=solid,gradientLinear&backgroundColor=b6e3f4,c0aede,d1d4f9,ffdfbf,ffd5dc`
          "
        >
          <ImageCropDialog
            v-if="session?.user.username === profile?.username"
