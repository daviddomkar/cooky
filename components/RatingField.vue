...
<template>
  <div class="max-w-60 w-60 flex flex-row items-end justify-between gap-4">
    <div
    ...
    >
      ...
      >
        <div
          class="i-cooky:star relative text-amber group-hover:text-amber"
          :class="{
        ...
        >
          ...
          >
            <div
              class="i-cooky:starhalf text-amber"
              :class="{
